...
export function Page({
  ...
  return (
    <div
      style={style}
      className={clsx(
        "absolute inset-0 border border-gray-900/5 bg-clip-padding bg-gray-200 rounded-xl shadow-lg p-10 animate-in",
      )}
    >
      {!isTopLevel && (
        <div
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="flex flex-col gap-6">
          <h2 className="text-2xl font-semibold flex items-start flex-col gap-1">
            <span>
              {name}
